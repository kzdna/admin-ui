  ...
  return (
    <main className="min-h-screen bg-special-mainBg flex justify-center items-center">
      ...
      <div className="w-full max-w-sm">
        {/* logo start */}
        <div className="flex justify-center font-poppins tracking-wide text-primary text-4xl mb-8">
        ...
        <form action="">
          ...
          <button
            className="h-12 rounded-md text-sm bg-primary w-full text-white hover:bg-opacity-90 transition"
            type="submit"
          >
            Login
          </button>
        ...
        {/* divider start */}
        <div className="my-9 flex items-center justify-center text-xs text-gray-03 relative">
        ...
        <button
          className="h-12 flex items-center justify-center rounded-md text-sm w-full bg-gray-05 text-gray-01 hover:bg-gray-100 transition"
          type="button"
        >
          <svg
